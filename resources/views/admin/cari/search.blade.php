...
<div class="col-12">
  <form action="{{route('admin.cari.carisearch')}}" type="get">
    ...
    <div class="col-md-2 text-center mx-2 my-1">
            ...
            <input type="text" placeholder="Stok kodu ile ara.." value="{{@$_GET['carikodu']}}" name="carikodu" class="form-control h-25 text-center">
        </div>
        
        <div class="col-md-3 text-center mx-2 my-1">
            <label for="">Cari Adı</label>
            <input type="text" placeholder="Stok adı ile ara.." value="{{@$_GET['cariadi']}}" name="cariadi" class="form-control h-25 text-center">
        </div>
...
<div class="col-md-12 m-0 p-0 table-responsive">
    ...
    <div class="float-left mt-2">
        <span class="font-sizerem ">Toplam Cari Sayısı :</span>
    </div>
