            ...
            <div class="row">
                <div class="col-md-10">
                    <select name="sira" id="" class="form-control text-center" style="padding:0px; height: 21px;">
                        <option value="1" @if(@$_GET['sira']==1) selected @endif>Grup Adına Göre Sırala</option>
                        <option value="2" @if(@$_GET['sira']==2) selected @endif>Grup Adına Göre Tersten Sırala</option>
                    </select>
                </div>
                <div class="col-md-2">
